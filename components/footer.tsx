  ...
  return (
    <footer id="contact-us" className="bg-green-900 text-white py-20 relative">
          ...
          <div className="md:col-span-4">
            ...
            <ul className="space-y-4">
              <li className="flex items-center group">
                ...
                <span className="group-hover:text-green-300 transition-colors">+91 9188655439</span>
              </li>
              <li className="flex items-center group">
                <Mail className="mr-3 text-green-400 group-hover:text-green-300 transition-colors" size={20} />
                <span className="group-hover:text-green-300 transition-colors">ayushmukherjee1105@gmail.com</span>
              </li>
              <li className="flex items-center group">
      ...
      <div className="mt-8 pt-4 border-t border-green-800 text-center text-sm text-gray-300">
        <p>© {new Date().getFullYear()} Encore. All rights reserved.</p>
      </div>
    </footer>
  )
}
